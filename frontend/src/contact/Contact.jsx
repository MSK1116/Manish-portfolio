...
import Svg_team from "../SVG/Svg_team";
      ...
      xl:px-5 lg:flex-row">
          <div className="flex flex-col items-center w-full pt-5 pr-10 pb-20 pl-10 lg:pt-20 lg:flex-row">
            <div className="w-full bg-cover relative max-w-md lg:max-w-2xl lg:w-7/12">
              <div data-aos="zoom-in-down" data-aos-duration="1000" className="flex flex-col items-center justify-center w-full h-full relative lg:pr-10">
                <Svg_study_time />
              </div>
            </div>
            ...
            relative z-10">
                ...
                <form data-aos="zoom-in-left" data-aos-delay="500" action="https://formsubmit.co/contact@msmahato.com.np" method="POST" className="w-full">
