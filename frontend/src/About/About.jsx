                  ...
                  <div className="mt-4 md:mx-4 space-y-2 md:mt-0">
                    ...
                    <ul className="flex flex-col mr-4">
                      <div className=" space-y-4 ">
                        <p className="">
                          +2 Science: School Leaving Certificate (SLC) <br></br> GPA:- 11th:3.73 & 12th: N/A <br></br> National Examination Board (NEB), 2080BS <br></br>Capital College & Research Center (CCRC)-Balkumari, KTM
                        </p>
                        <hr></hr>
                        <p>
